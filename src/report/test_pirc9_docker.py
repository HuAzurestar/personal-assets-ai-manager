...
def test_tag_restore_after_merge_succeeds(client, page):
    ...
    state[system] = 'food'
    body(client.put(f'/paam/tag/v1/assignment/{entry["id"]}', json={
        'tag_state': state, 'expected_projection_version': entry['projection_version']}))
