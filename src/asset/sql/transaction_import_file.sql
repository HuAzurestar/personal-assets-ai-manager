...
CREATE TABLE IF NOT EXISTS transaction_import_file /* 一次交易数据导入的来源文件 */ (
    ...
    source_type INTEGER NOT NULL DEFAULT 0 /* 来源：0=UNKNOWN，1=MANUAL，101=ALIPAY，102=WECHAT，201=CCB_BANK，202=ABC_BANK，203=CMB_BANK */ CHECK (source_type IN (0, 1, 101, 102, 201, 202, 203)),
    filename TEXT NOT NULL /* 用户看到的原始文件名 */ CHECK (filename <> ''),
    file_format INTEGER NOT NULL DEFAULT 0 /* 实际解析内容格式：0=UNKNOWN，1=CSV，2=XLS，3=XLSX，4=PDF */ CHECK (file_format IN (0, 1, 2, 3, 4)),
