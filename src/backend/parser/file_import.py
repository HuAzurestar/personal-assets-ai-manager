...
from backend.parser.importing import HEADER_ALIASES, ImportedRow, _normalise
from backend.parser.provider_template import locate_provider_table
...
def _read_tabular(payload: bytes, extension: str, source_type: str) -> tuple[list[str], list[dict[str, str]], dict[str, str | None], list[int]]:
    ...
    from backend.parser.statement_parser import identify
